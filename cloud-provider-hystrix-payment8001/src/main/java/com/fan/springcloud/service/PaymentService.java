...
public class PaymentService {
    ...
    public String paymentInfo_TimeOut(Integer id){
        ...
        return "线程池："+Thread.currentThread().getName()+"\t"+"paymentInfo_TimeOut,id:"+"\t"+"O(n_n)O哈哈!"+"耗时(毫秒)："+timeNUmber;
    }
    public String paymentInfo_TimeOutHandler(Integer id){
        return "线程池："+Thread.currentThread().getName()+"\t"+"paymentInfo_TimeOut,有点忙请稍后再试"+"\t"+"O(-_-)O~!";
    }
